...
int main(int argc, char** argv)
{
    ...
    getopt_add_int(gopt, '\0', kHitOddsArg, "32", "Amount to increase log-odds when a cell is hit by a laser ray");
    getopt_add_int(gopt, '\0', kMissOddsArg, "16", "Amount to decrease log-odds when a cell is passed through by a laser ray");
